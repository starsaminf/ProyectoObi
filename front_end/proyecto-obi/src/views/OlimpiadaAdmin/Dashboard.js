        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="warning" stats icon>
              ...
              <p className={classes.cardCategory}>Grupos</p>
              <h3 className={classes.cardTitle}>{consoleSeleccionada.grup}</h3>
            </CardHeader>
            <CardFooter stats>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="success" stats icon>
              ...
              <h3 className={classes.cardTitle}>{consoleSeleccionada.cole}</h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <Update />
